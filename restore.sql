...
CREATE DATABASE dvdrental WITH TEMPLATE = template0 ENCODING = 'UTF8' --no-locale;


ALTER DATABASE dvdrental OWNER TO karthikarajendran;
...
ALTER TYPE public.mpaa_rating OWNER TO karthikarajendran;
...
ALTER DOMAIN public.year OWNER TO karthikarajendran;
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO karthikarajendran;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO karthikarajendran;
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO karthikarajendran;
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO karthikarajendran;
...
ALTER FUNCTION public.last_day(timestamp without time zone) OWNER TO karthikarajendran;
...
ALTER FUNCTION public.last_updated() OWNER TO karthikarajendran;
...
ALTER TABLE public.customer_customer_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.customer OWNER TO karthikarajendran;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO karthikarajendran;
...
ALTER AGGREGATE public.group_concat(text) OWNER TO karthikarajendran;
...
ALTER TABLE public.actor_actor_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.actor OWNER TO karthikarajendran;
...
ALTER TABLE public.category_category_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.category OWNER TO karthikarajendran;
...
ALTER TABLE public.film_film_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.film OWNER TO karthikarajendran;
...
ALTER TABLE public.film_actor OWNER TO karthikarajendran;
...
ALTER TABLE public.film_category OWNER TO karthikarajendran;
...
ALTER TABLE public.actor_info OWNER TO karthikarajendran;
...
ALTER TABLE public.address_address_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.address OWNER TO karthikarajendran;
...
ALTER TABLE public.city_city_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.city OWNER TO karthikarajendran;
...
ALTER TABLE public.country_country_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.country OWNER TO karthikarajendran;
...
ALTER TABLE public.customer_list OWNER TO karthikarajendran;
...
ALTER TABLE public.film_list OWNER TO karthikarajendran;
...
ALTER TABLE public.inventory_inventory_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.inventory OWNER TO karthikarajendran;
...
ALTER TABLE public.language_language_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.language OWNER TO karthikarajendran;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO karthikarajendran;
...
ALTER TABLE public.payment_payment_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.payment OWNER TO karthikarajendran;
...
ALTER TABLE public.rental_rental_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.rental OWNER TO karthikarajendran;
...
ALTER TABLE public.sales_by_film_category OWNER TO karthikarajendran;
...
ALTER TABLE public.staff_staff_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.staff OWNER TO karthikarajendran;
...
ALTER TABLE public.store_store_id_seq OWNER TO karthikarajendran;
...
ALTER TABLE public.store OWNER TO karthikarajendran;
...
ALTER TABLE public.sales_by_store OWNER TO karthikarajendran;
...
ALTER TABLE public.staff_list OWNER TO karthikarajendran;
...
\.
COPY public.actor (actor_id, first_name, last_name, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3057.dat';
...
\.
COPY public.address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3065.dat';
...
\.
COPY public.category (category_id, name, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3059.dat';
...
\.
COPY public.city (city_id, city, country_id, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3067.dat';
...
\.
COPY public.country (country_id, country, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3069.dat';
...
\.
COPY public.customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '/Users/karthikarajendran/Downloads/dvdrental/3055.dat';
...
\.
COPY public.film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '/Users/karthikarajendran/Downloads/dvdrental/3061.dat';
...
\.
COPY public.film_actor (actor_id, film_id, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3062.dat';
...
\.
COPY public.film_category (film_id, category_id, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3063.dat';
...
\.
COPY public.inventory (inventory_id, film_id, store_id, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3071.dat';
...
\.
COPY public.language (language_id, name, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3073.dat';
...
\.
COPY public.payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '/Users/karthikarajendran/Downloads/dvdrental/3075.dat';
...
\.
COPY public.rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3077.dat';
...
\.
COPY public.staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '/Users/karthikarajendran/Downloads/dvdrental/3079.dat';
...
\.
COPY public.store (store_id, manager_staff_id, address_id, last_update) FROM '/Users/karthikarajendran/Downloads/dvdrental/3081.dat';
